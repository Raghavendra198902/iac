          ...
          >
            ...
            <div className="relative z-10 text-white">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-4xl font-bold mb-2">10. Stakeholder Management & Cross-Functional Leadership</h1>
                  <p className="text-white/90 text-lg">Engage stakeholders, conduct workshops, resolve technical conflicts</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-8 border border-white/50 dark:border-gray-700/50 shadow-xl">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300">
                Content for Stakeholder Management & Cross-Functional Leadership will be added here. This page covers the comprehensive responsibilities and strategic impact of this EA focus area.
              </p>
            </div>
          </div>
