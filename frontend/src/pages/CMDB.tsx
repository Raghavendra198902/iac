...
export default function CMDB() {
  ...
  const [networkDevices, setNetworkDevices] = useState<NetworkDevice[]>([
    {
      ...
      ports: 48,
      connectedDevices: 32,
      lastDiscovered: '2025-11-17T10:00:00Z',
    },
    {
      id: 'net-002',
      name: 'main-switch-01',
  ...
  const [ciItems] = useState<CIItem[]>([
    ...
    },
    {
      ...
      ipAddress: '10.0.2.20',
      version: 'Redis 7.0',
      lastUpdated: '2025-11-17T07:45:00Z',
      dependencies: [],
      tags: ['cache', 'redis', 'elasticache'],
      metadata: {
    ...
    },
    {
      ...
      location: 'US East',
      provider: 'AWS ALB',
      lastUpdated: '2025-11-17T06:30:00Z',
      dependencies: ['ci-001', 'ci-002'],
      tags: ['load-balancer', 'alb', 'network'],
      metadata: {
    ...
    },
    {
      ...
      location: 'US East',
      provider: 'AWS S3',
      lastUpdated: '2025-11-17T05:00:00Z',
      dependencies: [],
      tags: ['storage', 's3', 'backups'],
      metadata: {
        bucketSize: '2.5 TB',
        versioning: 'enabled',
        encryption: 'AES-256',
    ...
    },
    {
      ...
      ipAddress: '10.0.3.10',
      version: 'Ubuntu 22.04',
      lastUpdated: '2025-11-17T04:00:00Z',
      dependencies: ['ci-008'],
      tags: ['web', 'staging', 'nginx'],
      metadata: {
        cpu: '2 vCPU',
        memory: '8 GB',
        storage: '50 GB SSD',
  ...
  const [relationships] = useState<Relationship[]>([
    { id: 'rel-001', from: 'ci-001', to: 'ci-003', type: 'depends_on' },
    { id: 'rel-002', from: 'ci-001', to: 'ci-005', type: 'hosted_on' },
    { id: 'rel-003', from: 'ci-002', to: 'ci-003', type: 'depends_on' },
    { id: 'rel-004', from: 'ci-002', to: 'ci-004', type: 'depends_on' },
    { id: 'rel-005', from: 'ci-005', to: 'ci-001', type: 'connects_to' },
    { id: 'rel-006', from: 'ci-005', to: 'ci-002', type: 'connects_to' },
    { id: 'rel-007', from: 'ci-003', to: 'ci-006', type: 'depends_on' },
    { id: 'rel-008', from: 'ci-007', to: 'ci-008', type: 'depends_on' },
  ]);
