  ...
  const agents: Agent[] = [
    {
      ...
      description: 'Lightweight enterprise CMDB agent with full inventory, monitoring, and compliance capabilities.',
      features: [
        '⚡ Lightweight Go binary (7.5 MB)',
        '🎯 One-click MSI installer with GUI',
      ...
      downloadUrl: '/downloads/cmdb-agent-windows-amd64.msi',
