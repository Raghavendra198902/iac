...
exports.strictCorsMiddleware = exports.strictCorsOptions = exports.createCustomCors = exports.corsMiddleware = exports.corsOptions = void 0;
...
const createCustomCors = (customOptions) => {
    return (0, cors_1.default)({ ...exports.corsOptions, ...customOptions });
};
exports.createCustomCors = createCustomCors;
/**
