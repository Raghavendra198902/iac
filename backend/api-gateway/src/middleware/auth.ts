...
export const authMiddleware = async (
  ...
  try {
    ...
    const publicPaths = ['/health', '/auth/login', '/auth/refresh', '/auth/sso', '/ai/generate', '/ai/optimize', '/ai/validate', '/downloads', '/telemetry', '/agents/heartbeat', '/v1/agent', '/collaboration'];
