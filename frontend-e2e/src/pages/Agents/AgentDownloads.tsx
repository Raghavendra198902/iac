  ...
  const agents: AgentPackage[] = [
    {
      ...
      version: '1.5.0',
      size: '13 MB',
      description: 'Enterprise-grade Windows agent with complete security monitoring, policy enforcement, WMI integration, Registry monitoring, Event Log API, PDH performance counters, Windows Defender, Firewall, and Windows Update tracking',
      downloadUrl: '/downloads/cmdb-agent-windows-amd64-v1.5.exe',
      ...
      features: [
        '🛡️ Automated policy enforcement (25+ security policies)',
        '✅ Compliance scoring and reporting (CIS, NIST)',
        ...
        '🔒 Auto-update capability with encryption',
    ...
    },
    {
      ...
      version: '1.0.0',
      size: '5.9 MB',
      description: 'Advanced command-line interface for Windows agent management, configuration, and troubleshooting with real-time diagnostics',
    ...
    },
    {
      ...
      version: '1.0.0',
      size: '8.2 MB',
      description: 'Production-ready Linux agent with systemd integration, cgroups monitoring, comprehensive hardware detection, and cross-platform collectors',
    ...
    },
    {
      ...
      version: '1.0.0',
      size: '7.7 MB',
      description: 'Optimized Linux agent for ARM64 architecture including Raspberry Pi, AWS Graviton, and edge computing devices',
    ...
    },
    {
      ...
      version: '1.0.0',
      size: '8.3 MB',
      description: 'Native macOS agent with launchd integration, System Extensions support, MDM compatibility, and comprehensive monitoring',
