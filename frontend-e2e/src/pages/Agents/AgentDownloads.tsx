  ...
  const agents: AgentPackage[] = [
    {
      ...
      version: '1.0.0',
      size: '8.5 MB',
      description: 'Enterprise-grade Windows agent with WMI integration, Registry monitoring, Event Log collection, and Windows Service management',
      ...
      downloads: 8420,
      status: 'stable',
      requirements: ['Windows Server 2016+', 'Windows 10/11', '.NET Framework 4.8+', '2 GB RAM', '100 MB Disk'],
      features: [
