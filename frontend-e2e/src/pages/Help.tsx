  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-green-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent mb-2">
            Help & Documentation
          </h1>
        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-8 border border-white/20">
          ...
          <p className="text-gray-300 mb-4">
            This is the Help & Documentation page. Add your content and functionality here.
          </p>
