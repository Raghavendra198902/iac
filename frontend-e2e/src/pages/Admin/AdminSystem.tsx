  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-red-400 via-pink-400 to-purple-400 bg-clip-text text-transparent mb-2">
        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-8 border border-white/20">
          ...
          <p className="text-gray-300 mb-4">
            This is the System Configuration page. Add your content and functionality here.
          </p>
